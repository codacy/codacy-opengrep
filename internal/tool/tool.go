...
// New creates a new instance of Codacy Opengrep.
func New() codacyOpengrep {
	return codacyOpengrep{}
}

// Codacy Opengrep tool implementation
type codacyOpengrep struct {
}

// https://github.com/uber-go/guide/blob/master/style.md#verify-interface-compliance
var _ codacy.Tool = (*codacyOpengrep)(nil)

// Run runs the Opengrep implementation
func (s codacyOpengrep) Run(ctx context.Context, toolExecution codacy.ToolExecution) ([]codacy.Result, error) {
